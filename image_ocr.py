...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def get_batch(self, index, size, train):
        ...
        # X=X_data[0].reshape(1,128,64)
        # print(X[0].shape)
        # plt.imshow(X[0])
        # import random
        # xx=random.randint(1,1500)
        # # string="hello%d.png"
        # plt.savefig("Hello_"+str(xx)+".png",)

        # print("X_data",len(X_data[0]))
        # print("Labels",labels[0])
        # print("InputLeng",input_length[0])
        # print("LabelLenght",label_length[0])
        # # print(labels[0])
        # print(source_str[0])
        # print(labels[2])
        # print(source_str[2])
